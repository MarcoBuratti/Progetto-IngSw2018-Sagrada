...
class RowShadeVarietyTest {
    ...
    void scoreEffect() throws NotValidParametersException, NotValidNumberException {
        ...
        dashboard.setDieOnCell(0,1,new Die(Colour.BLUE));
        ...
        dashboard.setDieOnCell(0,3,new Die(Colour.RED));
        dashboard.getMatrixScheme()[0][3].getDie().setNumber(1);

        Assertions.assertEquals(0, new RowShadeVariety().scoreEffect(dashboard));

        dashboard.setDieOnCell(0,4,new Die(Colour.VIOLET));
        ...
        dashboard.setDieOnCell(3,0,new Die(Colour.BLUE));
