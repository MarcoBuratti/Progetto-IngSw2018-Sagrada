...
class DiceBagTest {
    ...
    private int colorCounter(List<Die> diceSet, Color C){
        int counter = 0;
        for(Die d: diceSet)
    ...
    @Test
    void goodExtraction() throws NotEnoughDiceLeftException {
        DiceBag bag = new DiceBag();
        Die d1,d2;
        d1 = bag.extract();
        ...
        assertEquals(89, bag.getDiceSet().size());
        ArrayList<Die> diceSet = new ArrayList<>( bag.extractSet(7) );
